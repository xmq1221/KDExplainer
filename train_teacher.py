...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default = '/home/yxy/kaecode3/LTB_kd/configs/cifar-10/seed-1029/valina/train_ResNet50.yml')
    parser.add_argument("--logdir", type=str, default = '/home/yxy/kaecode3/LTB_kd/log')
